...
lora_model_path = "rtahmasbi/lora-llama3-gsm8k"
...
# -------------------------------
def solve_problem(model, problem: str, max_new_tokens=256):
...
for p in problems:
    print(f"Problem: {p}")
    print("Answer:", solve_problem(base_model, p))
    print("-"*50)


print("-"*80, "trained model")
for p in problems:
    print(f"Problem: {p}")
    print("Answer:", solve_problem(model, p))
    print("-"*50)
...
python llama_to_thinking_inference.py
