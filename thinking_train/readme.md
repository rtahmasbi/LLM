...
vastai create instance 29019340 --template_hash 222392e8bff8afae7b41093613548200 --disk 100 --label ras1

vastai show instances
vastai start instance 32036468
vastai start instance $(vastai show instances --raw | jq -r '.[] | select(.label=="ras1") | .id')
vastai ssh-url 32036468
> ssh://root@80.188.223.202:11024

ssh $(vastai ssh-url 32036468)

touch ~/.no_auto_tmux



vastai destroy instance 32036468
